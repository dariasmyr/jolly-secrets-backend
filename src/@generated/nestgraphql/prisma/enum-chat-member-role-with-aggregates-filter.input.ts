...
import { NestedEnumChatMemberRoleWithAggregatesFilter } from './nested-enum-chat-member-role-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumChatMemberRoleFilter } from './nested-enum-chat-member-role-filter.input';

@InputType()
export class EnumChatMemberRoleWithAggregatesFilter {
