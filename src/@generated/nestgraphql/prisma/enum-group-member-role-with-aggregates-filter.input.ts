...
import { NestedEnumGroupMemberRoleWithAggregatesFilter } from './nested-enum-group-member-role-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumGroupMemberRoleFilter } from './nested-enum-group-member-role-filter.input';

@InputType()
export class EnumGroupMemberRoleWithAggregatesFilter {
