...
-- CreateEnum
CREATE TYPE "EventStatus" AS ENUM ('OPEN', 'EXPIRED', 'CLOSED');

-- CreateEnum
CREATE TYPE "EventApplicationStatus" AS ENUM ('LOOKING_FOR_PAIR', 'PAIRED', 'GIFT_SENT', 'GIFT_RECEIVED', 'GIFT_NOT_RECEIVED');
...
CREATE TABLE "EventApplicationPair" (
    ...
    "eventApplicationSecondId" INTEGER,
    "chatId" INTEGER,
...
-- CreateIndex
CREATE UNIQUE INDEX "OneTimeCode_telegramId_key" ON "OneTimeCode"("telegramId");
...
-- AddForeignKey
ALTER TABLE "EventApplicationPair" ADD CONSTRAINT "EventApplicationPair_eventApplicationSecondId_fkey" FOREIGN KEY ("eventApplicationSecondId") REFERENCES "EventApplication"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "EventApplicationPair" ADD CONSTRAINT "EventApplicationPair_chatId_fkey" FOREIGN KEY ("chatId") REFERENCES "Chat"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "ChatMember" ADD CONSTRAINT "ChatMember_accountId_fkey" FOREIGN KEY ("accountId") REFERENCES "Account"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ChatMember" ADD CONSTRAINT "ChatMember_chatId_fkey" FOREIGN KEY ("chatId") REFERENCES "Chat"("id") ON DELETE SET NULL ON UPDATE CASCADE;
